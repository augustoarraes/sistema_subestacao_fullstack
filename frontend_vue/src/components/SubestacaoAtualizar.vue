<template>
    <div class="container">
      ...
      <div class="card">
        ...
        <!-- Formulário para adicionar nova RedeMT -->
        <h4 style="margin-top: 20px;">Adicionar Nova Rede MT</h4>
        <form @submit.prevent="adicionarRedeMT" class="form-inline">
          <div class="form-row">
            <label>Código</label>
        ...
        <!-- Tabela de RedesMT -->
        <h4 style="margin-top: 20px;">Redes MT Existentes</h4>
...
const adicionarRedeMT = () => {
  if (!novaRede.value.codigo || !novaRede.value.nome || !novaRede.value.tensaoNominal) {
    alert('Preencha todos os campos da nova RedeMT.')
    return
  }
